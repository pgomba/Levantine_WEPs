...
object<-Levant_WEPS_table%>%
  ...
  mutate(url=paste0("https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:",Kew_id),
         ...
         `Family / Scientific name`= ifelse(is.na(Kew_id),`Family / Scientific name`, paste0("<a href=",url,">",
                                            "<div style='line-height:14px'><span style='font-style:italic;font-size:16px'>",
                                            word(`Family / Scientific name`, 1,2,sep=" ") ,
                                            "</div> </a>
        <div style='line-height:14px'><span style ='font-weight:bold;color:black;font-size:12px'>",
        authors,
        "</span></div>
        <div style='line-height:12px'><span style ='font-weight:bold;color:grey;font-size:10px'> IPNI: ",
        Kew_id,
        "</span></div>")),
